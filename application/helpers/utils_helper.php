...
//comprobar las peticiones ajax para evitar accesos
    ...
    function get_info($id){
        $ci =& get_instance();
        $val = $ci->generic_model->get_val('bill_empre_info', $id, 'content', 'variable');
        return $val;
    }
    ...
    function no_redondear($number, $digitos)
    ...
    /* Obtene el valor de una fecha de excel */
    function get_fecha_xls($PHPExcel,$col,$row){
        $res = $PHPExcel->getActiveSheet()->getCellByColumnAndRow($col,$row)->getCalculatedValue();
        return PHPExcel_Style_NumberFormat::toFormattedString($res,'YYYY-MM-DD' );
    }
    /* Obtene el valor de una fecha de excel */
    function get_hora_xls($PHPExcel,$col,$row){
        $res = $PHPExcel->getActiveSheet()->getCellByColumnAndRow($col,$row)->getCalculatedValue();
        return PHPExcel_Style_NumberFormat::toFormattedString($res,'HH:I:SS' );
    }
